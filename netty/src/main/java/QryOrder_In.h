...
#ifndef _TFZQ_QRYORDER_IN_H_
#define _TFZQ_QRYORDER_IN_H_
...
#pragma GCC diagnostic pop
    ...
    QryOrder_In &putOrderRef(const char *src)
    {
    ...
    QryOrder_In &putOrderRef(const std::string& str)
    {
...
#pragma GCC diagnostic pop
    ...
    {
        std::memcpy(m_buffer + m_offset + 66, src, 17);
        return *this;
    }

    std::string getOrderSysIDAsString() const
    {
        std::string result(m_buffer + m_offset + 66, 17);
        return result;
    }

    QryOrder_In &putOrderSysID(const std::string& str)
    {
        std::memcpy(m_buffer + m_offset + 66, str.c_str(), 17);
        return *this;
    }
...
#pragma GCC diagnostic pop
    ...
    char orderLocalID(const std::uint64_t index) const
    {
        ...
        return (*((char *)(m_buffer + m_offset + 83 + (index * 1))));
    }
    ...
    void orderLocalID(const std::uint64_t index, const char value)
    {
        ...
        *((char *)(m_buffer + m_offset + 83 + (index * 1))) = (value);
    }
    ...
    std::uint64_t getOrderLocalID(char *dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 83, length);
        return length;
    }

    QryOrder_In &putOrderLocalID(const char *src)
    {
        std::memcpy(m_buffer + m_offset + 83, src, 13);
        return *this;
    }

    std::string getOrderLocalIDAsString() const
    {
        std::string result(m_buffer + m_offset + 83, 13);
        return result;
    }

    QryOrder_In &putOrderLocalID(const std::string& str)
    {
        std::memcpy(m_buffer + m_offset + 83, str.c_str(), 13);
        return *this;
    }
