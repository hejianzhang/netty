...
#ifndef _TFZQ_RSPLOGIN_IN_H_
#define _TFZQ_RSPLOGIN_IN_H_
...
#pragma GCC diagnostic pop
    ...
    {
        std::memcpy(m_buffer + m_offset + 9, src, 9);
        return *this;
    }

    std::string getLoginTimeAsString() const
    {
        std::string result(m_buffer + m_offset + 9, 9);
        return result;
    }

    RspLogin_In &putLoginTime(const std::string& str)
    {
        std::memcpy(m_buffer + m_offset + 9, str.c_str(), 9);
        return *this;
    }
...
#pragma GCC diagnostic pop
    ...
    char brokerID(const std::uint64_t index) const
    {
        ...
        return (*((char *)(m_buffer + m_offset + 18 + (index * 1))));
    }
    ...
    void brokerID(const std::uint64_t index, const char value)
    {
        ...
        *((char *)(m_buffer + m_offset + 18 + (index * 1))) = (value);
    }
    ...
    std::uint64_t getBrokerID(char *dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 18, length);
        return length;
    }

    RspLogin_In &putBrokerID(const char *src)
    {
        std::memcpy(m_buffer + m_offset + 18, src, 11);
        return *this;
    }

    std::string getBrokerIDAsString() const
    {
        std::string result(m_buffer + m_offset + 18, 11);
        return result;
    }

    RspLogin_In &putBrokerID(const std::string& str)
    {
        std::memcpy(m_buffer + m_offset + 18, str.c_str(), 11);
        return *this;
    }
...
#pragma GCC diagnostic pop
    ...
    {
        std::memcpy(m_buffer + m_offset + 29, src, 15);
        return *this;
    }

    std::string getUserIDAsString() const
    {
        std::string result(m_buffer + m_offset + 29, 15);
        return result;
    }

    RspLogin_In &putUserID(const std::string& str)
    {
        std::memcpy(m_buffer + m_offset + 29, str.c_str(), 15);
        return *this;
    }
...
#pragma GCC diagnostic pop
    ...
    RspLogin_In &frontID(const std::uint32_t value)
    {
...
#pragma GCC diagnostic pop
    ...
    RspLogin_In &sessionID(const std::uint32_t value)
    {
...
#pragma GCC diagnostic pop
    ...
    static SBE_CONSTEXPR const std::uint32_t maxOrderRefNullValue()
    {
        return SBE_NULLVALUE_UINT32;
    }

    static SBE_CONSTEXPR const std::uint32_t maxOrderRefMinValue()
    {
        return 0;
    }

    static SBE_CONSTEXPR const std::uint32_t maxOrderRefMaxValue()
    {
        return 4294967293;
    }
    ...
    std::uint32_t maxOrderRef(void) const
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::uint32_t *)(m_buffer + m_offset + 52)));
    }

    RspLogin_In &maxOrderRef(const std::uint32_t value)
    {
