...
@javax.annotation.Generated(value = {"tfzq.TradeDate_InDecoder"})
@SuppressWarnings("all")
public class TradeDate_InDecoder
{
    ...
    private final TradeDate_InDecoder parentMessage = this;
    ...
    public TradeDate_InDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[TradeDate_In](sbeTemplateId=");
